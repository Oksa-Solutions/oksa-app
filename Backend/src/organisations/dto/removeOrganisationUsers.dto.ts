...
export class removeOrganisationUsersDto
  implements Readonly<removeOrganisationUsersDto>
{
  ...
  public static toEntity(dto: removeOrganisationUsersDto): Organisation {
    const updatedOrg = new Organisation();
    updatedOrg.uuid = dto.uuid;
