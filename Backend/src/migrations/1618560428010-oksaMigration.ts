...
export class oksaMigration1618560428010 implements MigrationInterface {
    name = 'oksaMigration1618560428010'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "logins" DROP COLUMN "userUUID"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "organisations"."lastModified" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "organisations"."created" IS NULL`);
        await queryRunner.query(`ALTER TABLE "logins" ADD "userUUID" character varying(36) NOT NULL`);
    }
