...
export class oksaMigration1623172144377 implements MigrationInterface {
    name = 'oksaMigration1623172144377'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "organisations" DROP COLUMN "name"`);
        await queryRunner.query(`ALTER TABLE "organisations" ADD "name" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "organisations" ADD CONSTRAINT "UQ_4a3dcb66f1630f551b81bca1b34" UNIQUE ("name")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "meetings_authorized_users_users" ADD CONSTRAINT "FK_486f56b0164bb7db47bca1015f8" FOREIGN KEY ("meetingsUuid") REFERENCES "meetings"("uuid") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "cards" ADD CONSTRAINT "FK_806da3a699248dec86bd083167c" FOREIGN KEY ("meetingUuid") REFERENCES "meetings"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organisations" DROP CONSTRAINT "UQ_4a3dcb66f1630f551b81bca1b34"`);
        await queryRunner.query(`ALTER TABLE "organisations" DROP COLUMN "name"`);
        await queryRunner.query(`ALTER TABLE "organisations" ADD "name" character varying(300) NOT NULL`);
    }
